@echo off
rem Double-click on the computer that records the Polar sensors. Ctrl+C to stop.
cd /d "%~dp0"
chcp 65001 >nul
...
echo ==============================================================
echo  Polar sensors only (two-computer setup)
...
echo  Files: %~dp0data
echo ==============================================================
".venv\Scripts\python.exe" record_all.py --only polar %*
echo.
